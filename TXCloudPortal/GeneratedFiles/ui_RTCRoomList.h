/********************************************************************************
** Form generated from reading UI file 'RTCRoomList.ui'
**
...
#ifndef UI_RTCROOMLIST_H
#define UI_RTCROOMLIST_H
...
public:
    ...
    void setupUi(QDialog *RTCRoomList)
    {
        if (RTCRoomList->objectName().isEmpty())
            RTCRoomList->setObjectName(QStringLiteral("RTCRoomList"));
        RTCRoomList->resize(430, 448);
        RTCRoomList->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(RTCRoomList);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(5, 5, 5, 5);
        widgetMain = new QWidget(RTCRoomList);
...
"}"));
        ...
        retranslateUi(RTCRoomList);

        QMetaObject::connectSlotsByName(RTCRoomList);
    } // setupUi

    void retranslateUi(QDialog *RTCRoomList)
    {
        RTCRoomList->setWindowTitle(QApplication::translate("RTCRoomList", "RTCRoomList", nullptr));
        btn_close->setText(QString());
        title->setText(QString());
        label_conf->setText(QString());
        label_no_room->setText(QApplication::translate("RTCRoomList", "\346\232\202\346\227\266\346\262\241\346\234\211\346\210\277\351\227\264,\350\257\267\345\210\233\345\273\272\346\210\277\351\227\264", nullptr));
        btn_create->setText(QApplication::translate("RTCRoomList", "\345\210\233\345\273\272\346\210\277\351\227\264", nullptr));
        btn_join->setText(QApplication::translate("RTCRoomList", "\345\212\240\345\205\245\346\210\277\351\227\264", nullptr));
    } // retranslateUi

};

namespace Ui {
    class RTCRoomList: public Ui_RTCRoomList {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_RTCROOMLIST_H
