...
#include "../../common/RoomService/CaptureScreen.h"
...
QT_MOC_LITERAL(1, 14, 16), // "signalSelectRect"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 11) // "captureRect"

    },
    "CaptureScreen\0signalSelectRect\0\0"
    "captureRect"
};
...
void CaptureScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalSelectRect((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureScreen::*)(QRect );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureScreen::signalSelectRect)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureScreen::signalSelectRect(QRect _t1)
{
