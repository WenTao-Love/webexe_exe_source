...
#include "../../common/RoomService/ImageDownloader.h"
...
QT_MOC_LITERAL(1, 16, 16), // "downloadFinished"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 7), // "success"
QT_MOC_LITERAL(4, 42, 5) // "image"

    },
    "ImageDownloader\0downloadFinished\0\0"
    "success\0image"
};
...
void ImageDownloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->downloadFinished((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageDownloader::*)(bool , QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageDownloader::downloadFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageDownloader::downloadFinished(bool _t1, QByteArray _t2)
{
