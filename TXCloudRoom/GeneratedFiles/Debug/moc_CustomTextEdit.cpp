...
QT_MOC_LITERAL(3, 29, 16) // "ctrlEnterPressed"

    },
    "CustomTextEdit\0enterPressed\0\0"
    "ctrlEnterPressed"
};
...
void CustomTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CustomTextEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomTextEdit::ctrlEnterPressed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void CustomTextEdit::ctrlEnterPressed()
{
