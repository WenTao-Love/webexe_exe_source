...
QT_MOC_LITERAL(3, 22, 19), // "ApplicationFunction"
QT_MOC_LITERAL(4, 42, 4), // "func"
QT_MOC_LITERAL(5, 47, 6) // "handle"

    },
    "Application\0dispatch\0\0ApplicationFunction\0"
    "func\0handle"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dispatch((*reinterpret_cast< ApplicationFunction(*)>(_a[1]))); break;
        case 1: _t->handle((*reinterpret_cast< ApplicationFunction(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Application::*)(ApplicationFunction );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Application::dispatch)) {
                *result = 0;
                return;
            }
        }
...
void *Application::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IHttpServerCallback"))
        return static_cast< IHttpServerCallback*>(this);
...
// SIGNAL 0
void Application::dispatch(ApplicationFunction _t1)
{
