...
public:
    ...
    void setupUi(QDialog *DialogMessage)
    {
        ...
        widgetMain->setMinimumSize(QSize(380, 148));
        widgetMain->setMaximumSize(QSize(380, 168));
...
"}"));
        ...
        verticalLayout_3->setContentsMargins(24, 20, 24, 20);
        ...
        label_title->setMinimumSize(QSize(0, 60));
        QFont font;
